...
- Zone imagery timeline (migration 052) — dated drone/site photos per zone with a date slider on the zone page (Brian's Mavic Air 2 flies daily); evidence locker for closeout/pay apps. Next: georeferenced ortho overlays + SkyFi order button
