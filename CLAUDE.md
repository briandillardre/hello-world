...
14. **Growth Platform (the endgame)** — Ramp-style card + spend, partner-first lending, live company valuation + exit suite, benchmarks, AI "what lever next" advisor (hires/equipment/office/geography): `docs/GROWTH-PLATFORM.md`. Supersedes the old "financing = never" note. Order: charts/benchmarks → valuation card → HammerTrack Card → referral lending. Gated on PM Tier 1 + Founding-25 + Mercury/Stripe live.
