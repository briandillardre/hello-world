...
export function TodayTray({ assets, alerts, canViewCosts = false }: {
  ...
  return (
    // data-map-overlay: the map's stack glide/fan keep clear of this card
    // while it is open (MapView stackSafeArea).
    <div data-map-overlay="top" className="absolute left-1/2 -translate-x-1/2 top-[var(--ht-map-top,8px)] md:top-2 z-30 w-[min(400px,94vw)] rounded-2xl bg-navy-950/95 backdrop-blur border border-navy-700 shadow-panel overflow-hidden">
