              ...
              {canManage && (
                <div className="rounded-lg border border-navy-800 bg-navy-950 p-3 space-y-2">
                  <div className="flex items-center gap-2">
                    <p className="text-[12.5px] text-muted flex-1">No bank hookup needed to see the chase work: a $12.34 test swipe on your name fires the same push and text a real card alert would. Snap any photo to close it.</p>
                    <button
                      type="button"
                      disabled={pending}
                      onClick={() => start(async () => {
