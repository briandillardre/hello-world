...
| Crew phone as a BLE gateway (phone hears tool tags) | ✅ (foreground, Sep 9; ON BY DEFAULT in the app Sep 12 — background still needs the native update) | iOS Safari has no Web Bluetooth; background scanning needs native |
