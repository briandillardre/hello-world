...
export const LAYER_ROWS: LayerRowDef[] = [
  ...
  { id: 'planes-ground', label: 'Aircraft on the ground', group: 'sky', status: 'live', isLive: true, hint: 'taxiing, rolling and parked aircraft at the airfields in view · draws from airport zoom in, on its own or alongside Aircraft (live) · we show what is TRANSMITTING, so a tied-down aircraft with its avionics off sends nothing and cannot appear — a quiet field at 3 AM is honest, not broken' },
