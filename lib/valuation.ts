...
export const TRADES: TradeBenchmark[] = [
  ...
  { key: 'landscape', label: 'Landscaping / lawn care / grounds', marginLo: .06, marginHi: .10, revPerEmpLo: 120_000, revPerEmpHi: 180_000, sdeMultLo: 2.5, sdeMultHi: 3.5, revMultLo: .45, revMultHi: .70 },
...
export function matchTradeByKeywords(description: string): TradeBenchmark {
  ...
  const rules: [RegExp, string][] = [
    ...
    [/landscap|lawn|irrigation|tree|hardscape|mow|snow/, 'landscape'],
