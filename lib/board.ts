...
export const TASKS: BoardTask[] = [
  ...
  { id: 102, title: 'Customer #2: sister paving company in Charleston — get the owner registered', why: 'Sep 9: two OBD units (…33818, …48247), a TAT141 (…4734) and three Eye Beacons (…B56B, …B573, …B521) went with him. They are OFF the DCG placeholders and in DCG’s drawer. He registers at hammertrack.ai/register (company name = his company; that makes him the Master), tells you the email, and the six devices + assets move into his account in minutes — no rescans. Founding-25 terms apply.', owner: 'brian', state: 'open', sev: 'warn' },
